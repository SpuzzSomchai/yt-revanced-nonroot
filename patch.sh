...
java -jar revanced-cli*.jar -m revanced-integrations*.apk -b revanced-patches*.jar -a youtube-v$YTVERSION.apk ${patches[@]} --keystore=public.jks -p=public -o yt-$NAME-v$YTVERSION.apk
