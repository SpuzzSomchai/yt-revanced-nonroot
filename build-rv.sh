...
echo ""
java -jar revanced-cli.jar -a youtube.apk -b revanced-patches.jar -m revanced-integrations.apk -o revanced.apk -e hide-my-mix -e custom-video-buffer -e debugging -c 2>&1 | tee -a Patch.log
